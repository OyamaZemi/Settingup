...
1. **学生認証を受ける**  
   GitHub Education に学生として申請する必要がある．学校ドメインのメールアドレス，または学生証等の在籍証明書類の提出が求められる．参考リンク内のドキュメントから "Apply" リンクで申請し，承認を待つ．承認完了後に次の手順（Copilot 有効化）へ進む．なお，学生資格は毎月再評価され，失効すると無料利用も停止する．
